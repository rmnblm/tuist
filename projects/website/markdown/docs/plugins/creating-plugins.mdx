...
Template plugins can be used to share & reuse custom templates. Tuist will collect all templates from defined plugins and allow them to be used with commands like [`tuist scaffold`](/docs/commands/scaffold/).
...
We also recommend to create a following extension which will be similar to this:
...
This is to ensure that users do not have to reference your plugin with a `String` but can leverage your type-safe project description helpers.
